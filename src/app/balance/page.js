import Main from "@/components/Balance/Main";

export const metadata = {
  title: "AstroVachan: Balance n Recharge",
  description:
    "Recharge your account, check your balance, and consult with expert astrologers online now.",
  openGraph: {
